...
# Conexion Basica -------------------------------------------------------------
# bash dhusget.sh -u $USR_COP -p $PAS_COP
# bash dhusget.sh -u $USR_COP -p $PAS_COP -help

# Buscar por Mision -----------------------------------------------------------
# bash dhusget.sh -u $USR_COP -p $PAS_COP -m "Sentinel-1"
# bash dhusget.sh -u $USR_COP -p $PAS_COP -m "Sentinel-5 P"

# Buscar por instrumento ------------------------------------------------------
# bash dhusget.sh -u $USR_COP -p $PAS_COP -i "TROPOMI"

# Buscar por rango de fechas Ingestion ----------------------------------------
# bash dhusget.sh -u $USR_COP -p $PAS_COP  -s "2016-10-02T06:00:00.000Z" -e "2016-10-10T12:00:00.000Z"

# Buscar por rango de fechas Sensing ------------------------------------------
# bash dhusget.sh -u $USR_COP -p $PAS_COP  -S "2016-10-02T06:00:00.000Z" -E "2016-10-10T12:00:00.000Z"

# Buscar por coordenadas ------------------------------------------
# bash dhusget.sh -u $USR_COP -p $PAS_COP -c "-4.530,29.850:26.750,46.800"

# Buscar por tipo de producto ------------------------------------------
# bash dhusget.sh -u $USR_COP -p $PAS_COP -T "-4.530,29.850:26.750,46.800"
